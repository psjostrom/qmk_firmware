...
/* const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  KC_LSFT,        KC_Z,    KC_X,    KC_C,   KC_V,        KC_B,                   KC_N,   KC_M,     KC_COMM, KC_DOT,  KC_SLSH, SWE,  \
  ...
  KC_LSFT,        KC_Z,    KC_X,    KC_C,   KC_V,        KC_B,                   KC_N,   KC_M,     KC_COMM, KC_DOT,  KC_SLSH, BASE,  \
  KC_F13,         KC_LCTL, KC_LGUI, KC_LOG, KC_COPYPATH, KC_SPACE,               KC_ENT, LOWER,    KC_LEFT, KC_DOWN, KC_UP,   KC_RIGHT
  ),

  [LY_LOWER] = LAYOUT_ortho_5x12(
  QK_BOOTLOADER, KC_F1,   KC_F2,   KC_F3,   KC_F4,       KC_F5,            KC_F6,      KC_F7,     KC_F8,   KC_F9,   KC_F10,  XXXXXXX, \
  XXXXXXX,       XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,     KC_LINESTART,     KC_LINEEND, XXXXXXX,   XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, \
  MUTE_ZOOM,     KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC,     KC_PRVWD,         KC_NXTWD,   KC_UNDS,   KC_PLUS, KC_LCBR, KC_RCBR, KC_PIPE, \
  KC_F12,        KC_F17,  KC_F18,  KC_F19,  XXXXXXX,     KC_MVAPPL,        KC_MVAPPR,  KC_MAXAPP, KC_COLN, KC_DQUO, XXXXXXX, XXXXXXX, \
  XXXXXXX,       XXXXXXX, XXXXXXX, XXXXXXX, KC_IOSSHAKE, KC_DEVTOOLS,      XXXXXXX,    RAISE,     XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX
  ),
};
