...
/* const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [LY_BASE] = LAYOUT_ortho_5x12(
    ...
    KC_SCREENSHOT,  KC_LOG, KC_LCTL, KC_LGUI, KC_LALT, KC_SPACE,         KC_ENT, MO(LOWER), TG(SWE), KC_LEFT, KC_DOWN, KC_RIGHT
  ),
  [LY_SWE] = LAYOUT_ortho_5x12(
    KC_GRV,         KC_1,   KC_2,    KC_3,    KC_4,    KC_5,             KC_6,   KC_7,      KC_8,    KC_9,    KC_0,    KC_BSPC,  \
    KC_TAB,         KC_Q,   KC_W,    KC_E,    KC_R,    KC_T,             KC_Y,   KC_U,      KC_I,    KC_O,    KC_P,    KC_AA, \
  ...
  [LY_LOWER] = LAYOUT_ortho_5x12(
    ...
    KC_IOSSHAKE,   XXXXXXX, XXXXXXX, TO(BASE),TO(SWE), KC_COLN,          KC_DQUO,    XXXXXXX,   XXXXXXX, XXXXXXX,   XXXXXXX, XXXXXXX
  ),
  };
