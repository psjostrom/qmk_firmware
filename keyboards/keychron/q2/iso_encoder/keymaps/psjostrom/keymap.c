...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [LY_BASE] = LAYOUT_iso_68(
        ...
        KC_CAPS,  KC_A,       KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,      KC_NUHS,      KC_ENT,           KC_BACK,
    ...
    [LY_SWE] = LAYOUT_iso_68(
        ...
        KC_CAPS,  KC_A,       KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    LALT(KC_SCLN), LALT(KC_QUOT), LALT(KC_NUHS), KC_ENT,           KC_BACK,
        KC_LSFT,  KC_GRV,     KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,        KC_SLSH,                      KC_RSFT, KC_UP,
