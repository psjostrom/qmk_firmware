...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [LY_BASE] = LAYOUT_iso_68(
        KC_NUBS,  KC_1,       KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS,      KC_EQL,       KC_BSPC,          KC_MUTE,
        KC_TAB,   KC_Q,       KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC,      KC_RBRC,                        KC_DEL,
        LALT_T(KC_ESC),  KC_A,       KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,      KC_NUHS,      KC_ENT,           KC_BACK,
        TD(SHIFT_CAPS),  KC_GRV,     KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,                    KC_RSFT, KC_UP,
        TD(SCRSH_SHAKE),  KC_LGUI,    KC_LALT,                            KC_SPC,                             KC_RCMD, MO(LY_LOWER), MO(LY_RAISE), KC_LEFT, KC_DOWN, KC_RGHT),

    [LY_SWE] = LAYOUT_iso_68(
        KC_NUBS,  KC_1,       KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,          KC_MINS,       KC_EQL,        KC_BSPC,          KC_MUTE,
        KC_TAB,   KC_Q,       KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,          LGUI(KC_LBRC), KC_SCLN,                         KC_DEL,
        LALT_T(KC_ESC),  KC_A,       KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    LGUI(KC_SCLN), LGUI(KC_QUOT), KC_QUOT, KC_ENT,           KC_BACK,
        TD(SHIFT_CAPS),  KC_GRV,     KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,        KC_SLSH,                      KC_RSFT, KC_UP,
        TD(SCRSH_SHAKE),  KC_LGUI,    KC_LALT,                            KC_SPC,                             KC_RALT,       MO(LY_LOWER),  MO(LY_RAISE),  KC_LEFT, KC_DOWN, KC_RGHT),
