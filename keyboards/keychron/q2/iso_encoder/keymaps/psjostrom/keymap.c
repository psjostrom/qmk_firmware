...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [LY_BASE] = LAYOUT_iso_68(
        ...
        KC_LCTL,        KC_LGUI,    KC_LALT,                            KC_SPC,                             KC_RCMD, TD(SCRSH_SHAKE), MO(LY_RAISE), KC_LEFT, KC_DOWN, KC_RGHT),
    ...
    [LY_SWE] = LAYOUT_iso_68(
        ...
        TD(SHIFT_CAPS),   KC_GRV,     KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,        KC_SLSH,                       KC_RSFT, KC_UP,
        KC_LCTL, KC_LGUI, KC_LALT,                                        KC_SPC,                             KC_RALT,       TD(SCRSH_SHAKE), MO(LY_RAISE), KC_LEFT, KC_DOWN, KC_RGHT),
