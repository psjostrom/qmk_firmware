...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [MAC_BASE] = LAYOUT_iso_68(
        ...
        KC_LSFT,  LALT(KC_Z), KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,            KC_RSFT, KC_UP,
        KC_LCTL,  KC_LOPT,    KC_LCMD,                            KC_SPC,                             KC_RCMD, MO(_FN1), MO(_FN3), KC_LEFT, KC_DOWN, KC_RGHT),

    [SWE_BASE] = LAYOUT_iso_68(
        KC_NUBS,  KC_1,       KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,          KC_MINS,  KC_EQL,   KC_BSPC,          KC_MUTE,
        KC_TAB,   KC_Q,       KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,          LALT(KC_LBRC),  KC_RBRC,                    KC_DEL,
        KC_CAPS,  KC_A,       KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    LALT(KC_SCLN), LALT(KC_QUOT),  LALT(KC_SLSH),  KC_ENT,           KC_HOME,
        KC_LSFT,  LALT(KC_Z), KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,        KC_SLSH,            KC_RSFT, KC_UP,
        KC_LCTL,  KC_LOPT,    KC_LCMD,                            KC_SPC,                             KC_RALT,       MO(_FN2), MO(_FN3), KC_LEFT, KC_DOWN, KC_RGHT),
...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][2] = {
    ...
    [SWE_BASE] = { ENCODER_CCW_CW(KC_VOLD, KC_VOLU) },
